...
-- CreateEnum
CREATE TYPE "ClientStatus" AS ENUM ('CLIENT', 'INACTIVE', 'PROSPECTO');
...
CREATE TABLE "Lead" (
    ...
    "notes" TEXT,
    "internalClientId" INTEGER NOT NULL,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
-- CreateIndex
CREATE INDEX "Lead_internalClientId_idx" ON "Lead"("internalClientId");

-- CreateIndex
CREATE INDEX "Appointment_clientId_idx" ON "Appointment"("clientId");

-- CreateIndex
CREATE INDEX "Appointment_internalClientId_idx" ON "Appointment"("internalClientId");
...
-- CreateIndex
CREATE INDEX "Campaign_internalClientId_idx" ON "Campaign"("internalClientId");
...
-- CreateIndex
CREATE INDEX "Conversation_internalClientId_idx" ON "Conversation"("internalClientId");
...
-- CreateIndex
CREATE INDEX "CheckIn_internalClientId_idx" ON "CheckIn"("internalClientId");
...
-- CreateIndex
CREATE UNIQUE INDEX "TwilioSettings_accountSid_key" ON "TwilioSettings"("accountSid");
...
-- CreateIndex
CREATE INDEX "EvoSync_clientId_idx" ON "EvoSync"("clientId");

-- CreateIndex
CREATE INDEX "EvoSync_internalClientId_idx" ON "EvoSync"("internalClientId");
...
-- AddForeignKey
ALTER TABLE "Lead" ADD CONSTRAINT "Lead_internalClientId_fkey" FOREIGN KEY ("internalClientId") REFERENCES "Client"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Appointment" ADD CONSTRAINT "Appointment_internalClientId_fkey" FOREIGN KEY ("internalClientId") REFERENCES "Client"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Campaign" ADD CONSTRAINT "Campaign_internalClientId_fkey" FOREIGN KEY ("internalClientId") REFERENCES "Client"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Conversation" ADD CONSTRAINT "Conversation_internalClientId_fkey" FOREIGN KEY ("internalClientId") REFERENCES "Client"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Message" ADD CONSTRAINT "Message_conversationId_fkey" FOREIGN KEY ("conversationId") REFERENCES "Conversation"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "CheckIn" ADD CONSTRAINT "CheckIn_internalClientId_fkey" FOREIGN KEY ("internalClientId") REFERENCES "Client"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "EvoSync" ADD CONSTRAINT "EvoSync_internalClientId_fkey" FOREIGN KEY ("internalClientId") REFERENCES "Client"("id") ON DELETE CASCADE ON UPDATE CASCADE;
